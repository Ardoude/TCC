...
listaURLs = ['http://www.policiacivil.am.gov.br/?cat=4']
listaAlbum = ['http://www.policiacivil.am.gov.br/?cat=4']
listaPessoas = [] # Pessoas desaparecidas

# Regexs a serem aplicadas
regexLink = r'http://www\.policiacivil\.am\.gov\.br/\?cat=4&paged=(\d)\"' # Regex para encontrar link
