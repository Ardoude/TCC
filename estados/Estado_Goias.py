...
listaURLs = ['https://www.go.gov.br/servicos-digitais/dgpc/consulta-de-pessoas-desaparecidas-e-cadaveres-nao-identificados']
listaAlbum = ['https://www.go.gov.br/servicos-digitais/dgpc/consulta-de-pessoas-desaparecidas-e-cadaveres-nao-identificados']
listaPessoas = [] # Pessoas desaparecidas

# Regexs a serem aplicadas
regexLink = r'http://www\.go\.gov\.br/\?cat=4&paged=(\d)\"' # Regex para encontrar link
...
def extrair():
    ...
    listaAlbum.append = retornoRegexLink.copy() # Lista com todas as páginas individuais
