...
listaURLs = ['https://desaparecidos.pcivil.rj.gov.br/pesquisar']
listaAlbum = ['https://desaparecidos.pcivil.rj.gov.br/pesquisar']
listaPessoas = [] # Pessoas desaparecidas

# Regexs a serem aplicadas
regexLink = r'http://www\.desaparecidos\.pcivil\.rj\.gov\.br/pesquisar\?cat=4&paged=(\d)\"' # Regex para encontrar link
        ...
        if resposta.status_code == 200:
            ...
            try:
                ...
                if len(retornoRegexDados) > 0:
                    ...
                    Pessoa["estado"] = "Rio de Janeiro/RJ"
